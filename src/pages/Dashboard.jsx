...
const Dashboard = () => {
  ...
  useEffect(() => {
    const obtenerStats = async () => {
      ...
      try {
        const resTareas = await fetch(RUTAS_API.tareas, {
  ...
  return (
    <DashboardLayout>
      <div className="text-white p-6 max-w-6xl mx-auto">
        ...
        <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}>
          <Link to="/tareas" className="bg-gray-900 p-6 rounded-lg shadow border border-gray-700 hover:border-blue-500 hover:shadow-lg transition">
          ...
          <Link to="/eventos" className="bg-gray-900 p-6 rounded-lg shadow border border-gray-700 hover:border-purple-500 hover:shadow-lg transition">
            <div className="flex items-center gap-4">
          ...
          <Link to="/estadisticas" className="bg-gray-900 p-6 rounded-lg shadow border border-gray-700 hover:border-green-500 hover:shadow-lg transition">
            <div className="flex items-center gap-4">
          ...
          <Link to="/perfil" className="bg-gray-900 p-6 rounded-lg shadow border border-gray-700 hover:border-yellow-500 hover:shadow-lg transition">
            <div className="flex items-center gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
          <motion.div className="bg-gray-900 rounded-lg p-6 shadow border border-gray-700" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          ...
          <motion.div className="bg-gray-900 rounded-lg p-6 shadow border border-gray-700" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
        ...
        <motion.div className="bg-gray-900 rounded-lg p-6 shadow border border-gray-700" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
          <h2 className="text-xl font-semibold mb-4">Accesos Directos</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link to="/tareas" className="flex items-center gap-3 p-4 bg-gray-800 rounded-lg hover:bg-gray-700 transition">
              <FaPlusCircle className="text-blue-400 text-xl" />
              <span>Nueva Tarea</span>
            </Link>
            <Link to="/eventos" className="flex items-center gap-3 p-4 bg-gray-800 rounded-lg hover:bg-gray-700 transition">
              <FaCalendarAlt className="text-purple-400 text-xl" />
              <span>Nuevo Evento</span>
            </Link>
            <Link to="/estadisticas" className="flex items-center gap-3 p-4 bg-gray-800 rounded-lg hover:bg-gray-700 transition">
