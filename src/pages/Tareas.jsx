 ...
 return (
    <DashboardLayout>
      <div className="text-white p-6 max-w-5xl mx-auto">
        <h1 className="text-2xl font-bold mb-4">{modoEdicion ? 'Editar Tarea' : 'Nueva Tarea'}</h1>
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8">
          ...
          <input type="text" placeholder="Enlace relacionado" className="input" value={enlace} onChange={e => setEnlace(e.target.value)} />
          <input type="file" className="input" onChange={e => setArchivo(e.target.files[0])} />
          <textarea placeholder="Nota larga" className="input" value={nota} onChange={e => setNota(e.target.value)}></textarea>
        </div>

        <div className="mb-4">
          <div className="flex gap-2">
            <input type="text" placeholder="Agregar subtarea" className="input flex-1" value={subtareasInput} onChange={e => setSubtareasInput(e.target.value)} />
            <button onClick={() => {
