...
import { FaTasks, FaCheckCircle, FaClock, FaCalendarAlt, FaChartBar } from 'react-icons/fa';
            ...
            {Object.entries(tareasPorCategoria).map(([categoria, cantidad]) => (
              <div key={categoria} className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  <div 
                    className="w-32 bg-gray-600 rounded-full h-2 mr-2"
          ...
          <div className="space-y-3">
            {Object.entries(eventosPorTipo).map(([tipo, cantidad]) => (
              <div key={tipo} className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  <div 
                    className="w-32 bg-purple-500 rounded-full h-2 mr-2"
